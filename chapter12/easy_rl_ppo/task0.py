...
class Config:
    def __init__(self) -> None:
        ...
        ################################# 保存结果相关参数 ################################
        self.result_path = os.path.join(curr_path, f"outputs/{self.env_name}/results")  # 保存结果的路径
        self.model_path = os.path.join(curr_path, f"outputs/{self.env_name}/models")  # 保存模型的路径
...
if __name__ == "__main__":
    ...
    agent.save(path=cfg.model_path)  # 保持模型
